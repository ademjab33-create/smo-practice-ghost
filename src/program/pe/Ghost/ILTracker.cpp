...
void ILTracker::init() {
    ...
    mIsRunActive = false; mStartTick = 0; mEndTick = 0; mElapsedFrames = 0;
}

void ILTracker::detectKingdom(const char* stageName) {
    if (!stageName) return;
    if (std::strcmp(mCurrentStageName, stageName) == 0) return;
...
const char* ILTracker::getCurrentKingdomName() const {
    ...
    case KingdomId::Cap: return "Cap Kingdom"; case KingdomId::Cascade: return "Cascade Kingdom";
    case KingdomId::Sand: return "Sand Kingdom"; case KingdomId::Lake: return "Lake Kingdom";
    case KingdomId::Wooded: return "Wooded Kingdom"; case KingdomId::Cloud: return "Cloud Kingdom";
    case KingdomId::Lost: return "Lost Kingdom"; case KingdomId::Metro: return "Metro Kingdom";
    case KingdomId::Snow: return "Snow Kingdom"; case KingdomId::Seaside: return "Seaside Kingdom";
    case KingdomId::Luncheon: return "Luncheon Kingdom"; case KingdomId::Ruined: return "Ruined Kingdom";
    case KingdomId::Bowser: return "Bowser's Kingdom"; case KingdomId::Moon: return "Moon Kingdom";
    case KingdomId::DarkSide: return "Dark Side"; case KingdomId::DarkerSide: return "Darker Side";
    case KingdomId::Mushroom: return "Mushroom Kingdom"; default: return "Unknown";
    }
}

const char* ILTracker::getCurrentSegmentName() const {
    switch (mCurrentSegment) {
    case SegmentId::BowserBunnies: return "Bunnies"; case SegmentId::BowserOdyssey: return "Bowsers";
    case SegmentId::MoonEnd: return "Moon"; case SegmentId::CapEnd: return "Cap";
    case SegmentId::CascadeOdyssey: return "Cascade"; case SegmentId::SandOdyssey: return "Sand";
    case SegmentId::LakeOdyssey: return "Lake"; case SegmentId::WoodedOdyssey: return "Wooded";
    case SegmentId::CloudSkip: return "Cloud"; case SegmentId::LostOdyssey: return "Lost";
    case SegmentId::MetroOdyssey: return "Metro"; case SegmentId::SnowOdyssey: return "Snow";
    case SegmentId::SeasideOdyssey: return "Seaside"; case SegmentId::LuncheonOdyssey: return "Luncheon";
    case SegmentId::RuinedOdyssey: return "Ruined"; default: return "Full Kingdom";
    }
}

void ILTracker::update(al::Scene* scene) { if (mIsRunActive) mElapsedFrames++; }
void ILTracker::startRun() { mStartTick = nn::os::GetSystemTick().m_tick; mEndTick = mStartTick; mElapsedFrames = 0; mIsRunActive = true; }
void ILTracker::endRun() { if (!mIsRunActive) return; mEndTick = nn::os::GetSystemTick().m_tick; mIsRunActive = false; }
void ILTracker::resetRun() { mIsRunActive = false; mStartTick = 0; mEndTick = 0; mElapsedFrames = 0; }
s64 ILTracker::getElapsedTicks() const { if (mIsRunActive) return nn::os::GetSystemTick().m_tick - mStartTick; return mEndTick - mStartTick; }
...
void ILTracker::checkSplitConditions() { if (!mIsRunActive) return; }
